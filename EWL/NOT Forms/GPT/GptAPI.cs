...
namespace Eng_Flash_Cards_Learner.NOT_Forms
{
    public class GptAPI
    {
        ...
        const string MyApiKey = "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"; //PROTECT
        ...
        const string PromptForFC = "Create a short sentence where special word is missing. There's examble for 'one' and 'apple' words\r\n"
        ...
        public static async void GetResponse(string[] words, GptPurpose purpose, IOverlaySplashScreenHandle overlayPHandrer)
        {
            ...
            if (completionResult == null)
                GPTResponseHandler?.Invoke(null, overlayPHandrer);
